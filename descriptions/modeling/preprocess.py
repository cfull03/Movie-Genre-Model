...
def main(
    ...
    logger.success(
        "Successfully generated Descriptions and fitted and transformed the descriptions"
    )
    ...
    X_df = pd.DataFrame(X_dense, index=index, columns=[f"tfidf_{i}" for i in range(X.shape[1])])
