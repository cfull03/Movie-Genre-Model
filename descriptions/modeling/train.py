...
from descriptions.modeling.model import build_model, get_model_name, get_params, save_model
...
def main(
    ...
    with mlflow.start_run(run_name=run_name):
        try:
            ...
            logger.success(
                "Data split successfully (labels transformed through MultiLabelBinarizer)"
            )
