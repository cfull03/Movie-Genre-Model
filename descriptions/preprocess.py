...
from descriptions.modeling.model import build_preprocessor
...
def _build_vectorizer() -> TfidfVectorizer:
    """Build TfidfVectorizer. Deprecated: use build_preprocessor from model.py instead."""
    vectorizer, _ = build_preprocessor()
    return vectorizer


def _build_multilabel_binarizer() -> MultiLabelBinarizer:
    """Build MultiLabelBinarizer. Deprecated: use build_preprocessor from model.py instead."""
